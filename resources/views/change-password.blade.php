    ...
    <div class="card">
        <div class="card-body"><h3 class="text-center mt-0 m-b-15"><a href="#" class="logo logo-admin"><img
            ...
            <div class="p-3">
                ...
                <form class="form-horizontal m-t-20" method="POST" action="{{ route('password.reset', $token) }}">
                    @csrf
                    <div class="form-group row">
                        <div class="col-12">
                            <input id="password" type="password" class="form-control @error('password') is-invalid @enderror"
                                   name="password" placeholder="Password" value="{{ old('password') }}" required autofocus>
                            @error('password')
