<nav class="navbar-custom">
    <ul class="list-inline float-right mb-0">
        ...
        {{--                            <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-menu-lg"><!-- item-->--}}
        {{--                                <div class="dropdown-item noti-title"><h5><span class="badge badge-danger float-right">745</span>Messages--}}
        {{--                                    </h5></div><!-- item--> <a href="javascript:void(0);" class="dropdown-item notify-item">--}}
        ...
        {{--                                            text of the printing and typesetting industry.</small></p></a><!-- item--> <a--}}
        ...
        {{--                                            87 unread messages</small></p></a><!-- item--> <a href="javascript:void(0);"--}}
        ...
        {{--                                            long established fact that a reader will</small></p></a><!-- All--> <a--}}
        {{--                                    href="javascript:void(0);" class="dropdown-item notify-item">View All</a></div>--}}
        {{--                        </li>--}}
        {{--                        <li class="list-inline-item dropdown notification-list"><a--}}
        {{--                                class="nav-link dropdown-toggle arrow-none waves-effect" data-toggle="dropdown" href="#"--}}
        {{--                                role="button" aria-haspopup="false" aria-expanded="false"><i--}}
        ...
        {{--                            <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-menu-lg"><!-- item-->--}}
        {{--                                <div class="dropdown-item noti-title"><h5><span class="badge badge-danger float-right">87</span>Notification--}}
        {{--                                    </h5></div><!-- item--> <a href="javascript:void(0);" class="dropdown-item notify-item">--}}
        ...
        {{--                                            have 87 unread messages</small></p></a><!-- item--> <a--}}
        {{--                                    href="javascript:void(0);" class="dropdown-item notify-item">--}}
        {{--                                    <div class="notify-icon bg-warning"><i class="mdi mdi-martini"></i></div>--}}
        {{--                                    <p class="notify-details"><b>Your item is shipped</b><small class="text-muted">It is--}}
        {{--                                            a long established fact that a reader will</small></p></a><!-- All--> <a--}}
        {{--                                    href="javascript:void(0);" class="dropdown-item notify-item">View All</a></div>--}}
        {{--                        </li>--}}
...
{{--                <div class="dropdown-divider"></div>--}}
                <a class="dropdown-item" href="{{ route('admin.changePassword') }}"><i class="mdi mdi-logout m-r-5 text-muted"></i> Change Password</a>
                <a class="dropdown-item" href="{{ route('admin.profile') }}"><i class="mdi mdi-logout m-r-5 text-muted"></i> Profile</a>
