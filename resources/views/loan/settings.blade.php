...
@include('layouts.breadcrumb', ['pageName' => 'Loan Settings','page' => 'loan settings','submenu' => ''])
    ...
    <div class="col-lg-12">
        <div class="card m-b-30">
            <div class="card-body" >
                <div class="row">
                    <div class="col-6">
                        <h4 class="mt-0 header-title">All loan settings</h4>
                    </div>
                    <div class="col-6 text-right" >
                    <a href="{{route('admin.loan.settings.addview')}}" class='right btn btn-primary ml-2'>Add Loan Setting</a>
                    </div>
                </div>
                <br>
